...
> **Status:** Engineering roadmap — Phases I, II, III, IV and V implemented; Phase VI implemented (2026-09-26), with its card and UPI TEST verification still open ([runbook](phase-VI/manual-test.md))
>
