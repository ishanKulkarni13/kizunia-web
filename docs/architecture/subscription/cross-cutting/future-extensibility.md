...
| Plan changes for payment methods Razorpay cannot update (UPI, e-mandate, domestic cards) | A successor-subscription workflow would need one explicit relaxation of the open-subscription invariant — "one current plus at most one linked successor" — plus the existing command model, sync and anomaly detection. It is deliberately not built in V1: **deferred, not rejected**, by the owner on 2026-09-24 ([SB-LC-07](../../../project/feature-specification/subscription/decisions/lifecycle.md#sb-lc-07--razorpay-decides-whether-a-plan-change-is-possible), [B1](../../../project/feature-specification/subscription/open-decisions.md#b-resolved)). V1 keeps the seams that make it additive: [IB-21](../implementation/open-decisions.md#ib-21--plan-change-extensibility) |
