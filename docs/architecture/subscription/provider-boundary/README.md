...
| [`interface-and-abstraction.md`](interface-and-abstraction.md) | The narrow `BillingProvider`-shaped interface |
...
Facts were verified against current official Razorpay documentation on 2026-09-21. Razorpay's own
